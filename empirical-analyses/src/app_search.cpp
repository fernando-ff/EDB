...
void run_lsearch()
{
    ...
    std::cout << "\n=====> End Run Linear Search <=====\n" <<std::endl;

}

void run_bsearch()
{
    std::cout << "\n=====> Start Run Binary Search <=====\n" <<std::endl;
    ...
    std::cout << "\n=====> End Run Binary Search <=====\n" <<std::endl;

}

void run_bsearch_recursive()
{
    std::cout << "\n=====> Start Run Binary Search Recursive<=====\n" <<std::endl;
    ...
    {
        std::cout << ">>> Looking for value \'" << i << "\' in A4: ";
        auto result = bsearch_recursive( std::begin(A4), std::end(A4), i );
        ( result == std::end(A4) ) ?
            std::cout << "Search failed!\n" :
            std::cout << "Located target element at position " << std::distance( std::begin(A4), result ) << std::endl;
    }
    std::cout << "\n=====> End Run Binary Search Recursive<=====\n" <<std::endl;
